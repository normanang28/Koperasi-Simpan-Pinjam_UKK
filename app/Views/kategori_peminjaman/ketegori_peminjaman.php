<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            <div class="right-aligned">
                ...
                <a href="<?= base_url('/home/add_loan_category/')?>"><button class="btn btn-success"><i class="fa fa-plus"></i> Add</button></a>
                <?php }else{} ?>
            </div>
            <style>
                    ...
                    <tbody>
                        ...
                        foreach ($duar as $gas){
                          ...
                          <tr>
                            ...
                            <td class="text-center text-capitalize text-dark"><?php echo $gas->keterangan_kategori?></td>
                            <td>
                              <div class="button-container">
                                  <a href="<?= base_url('/home/edit_loan_category/'.$gas->id_katagori)?>"><button class="btn btn-warning"><i class="fa fa-edit"></i> </button></a>
                                  <a href="<?= base_url('/home/delete_loan_category/'.$gas->id_katagori)?>"><button class="btn btn-info"><i class="fa fa-trash"></i> </button></a>
                              </div>
                          </td>
                      </tr>
                  <?php }?>
    ...
    function displayDataOnPage(page) {
        ...
        for (let i = startIndex; i < endIndex && i < data.length; i++) {
            ...
            <td class="text-center text-capitalize text-dark">${gas.keterangan_kategori}</td>
            <td>
            <div class="button-container">
            <a href="<?= base_url('/home/edit_loan_category/') ?>/${gas.id_katagori}"><button class="btn btn-warning"><i class="fa fa-edit"></i> </button></a>
            <a href="<?= base_url('/home/delete_loan_category/') ?>/${gas.id_katagori}"><button class="btn btn-danger"><i class="fa fa-trash"></i> </button></a>
            </div>
            </td>
            </tr>
            `;
