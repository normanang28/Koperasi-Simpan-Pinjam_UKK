    ...
    <div class="card">
        <div class="card-body">
            <div class="basic-form">
                <form id="userForm" class="form-horizontal form-label-left" novalidate  action="<?= base_url('home/aksi_add_cooperative_officer')?>" method="post">

                    <div class="row">
                         <div class="mb-3 col-md-6">
                            <label class="form-label">NIK<span style="color: red;">*</span></label>
                            <input type="Number" id="nik" name="nik" 
                            class="form-control text-capitalize" placeholder="NIK">
                        </div>
                        <div class="mb-3 col-md-6">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        userForm.addEventListener("change", function() {
            ...
            const namaPengguna = document.getElementById("nama_petugas").value.trim();
            const email = document.getElementById("alamat").value.trim();
            const jkp = document.getElementById("jk").value;
            ...
            if (nik !== "" && namaPengguna !== "" && email !== "" && jkp !== "Select Gender" && jk && ttl !== "" !== "" && username !== "" && level !== "Select Level") {
