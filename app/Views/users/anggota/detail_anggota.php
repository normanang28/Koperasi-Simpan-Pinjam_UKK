    ...
    <div class="card">
        <div class="card-body">
            <div class="right-aligned">
                <a href="<?= base_url('/home/member/')?>" type="submit" class="btn btn-info"><i class="fa fa-undo"></i></button></a> 
                <a href="<?= base_url('/home/reset_member/'.$gas->id_anggota_user)?>"><button class="btn btn-info" title="Reset Password"><i class="fa fa-light fa-key"></i></button></a>
                <a href="<?= base_url('/home/edit_member/'.$gas->id_anggota_user)?>"><button class="btn btn-warning"><i class="fa fa-edit"></i> </button></a>
                <a href="<?= base_url('/home/delete_member/'.$gas->id_anggota_user)?>"><button class="btn btn-danger"><i class="fa fa-trash"></i> </button></a>         
            </div>
            <br>
            <style>
            ...
            <table class="table items-table table table-bordered table-striped verticle-middle table-responsive-sm">
                ...
                <tbody>
                  <tr>
                    <td class="text-center text-capitalize text-dark"><?php echo $gas->nama_anggota?></td>
