    ...
    <div class="card">
        <div class="card-body">
            <div class="basic-form">
                ...
                <form id="profileForm" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate action="<?= base_url('home/aksi_change_profile_member')?>" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            class="form-control text-capitalize" placeholder="Full Name" value="<?= $users->nama_anggota?>">
                        </div>
                        <div class="mb-3 col-md-6">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const initialData = {
            nama_petugas: "<?= $users->nama_anggota ?>",
            jk: "<?= $users->jk ?>",
            alamat: "<?= $users->alamat ?>",
        ...
        profileForm.addEventListener("change", function() {
            ...
            const currentData = {
                nama_petugas: document.getElementById("nama_anggota").value.trim(),
