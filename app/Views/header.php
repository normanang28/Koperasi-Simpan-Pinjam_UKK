        ...
        ***********************************-->
        <div class="nav-header">
            <a class="brand-logo" href="<?= base_url('/home/dashboard')?>" >
                <img class="logo-abbr" src="<?= base_url('/assets/images/settings_web/'.session()->get('foto_sekolah'))?>" alt="" style="width: 200px; height: auto;">
    			<img class="brand-title" src="<?= base_url('/assets/images/settings_web/'.session()->get('text_sekolah'))?>" alt="" style="width: 200px; height: auto;">
            </a>
...
<?php  if(session()->get('level')== 3) { ?>
                                     <a href="<?= base_url('/home/profile_member')?>" class="dropdown-item ai-icon">
                                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                        <span class="ms-2">Profile </span>
                                    </a>
<?php }else{} ?>
